<?php
  ...
  if(isset($_POST['upload'])){
	...
	// $id=$_POST['id'];
	 ...
	 $sql = "INSERT INTO furnished_aprt(img,name,rent,details) VALUES ('$image','$name','$rent','$details')";
	 mysqli_query($db ,$sql);
  ...
  if(isset($_POST['delete'])){
	  $info = getData();
	  $delete_query = "DELETE FROM furnished_aprt WHERE name = '$info[2]'";
	  try{
  ...
  if(isset($_POST['update'])){
    $info1 = getData();
    $update_query="UPDATE furnished_aprt SET img='$info1[1]',rent='$info1[3]',details='$info1[4]' WHERE name = '$info1[2]'";
...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="f_furnished.php">Full Furnished</a></li>
...
<div>
	<h3 align="center">Furnished Apartment</h3>
</div>


<div class="container">
	<form method="post"  action="f_furnished.php" enctype="multipart/form-data">
