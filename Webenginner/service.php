...
<html>
	...
	<div class="jumbotron"style=' border: 2px solid red;border-radius: 50px 20px;margin:10px;'>>
       <div class="pro">
	       <div class="row">
		       <div class="col-md-12">
			     <!-- Heading and para -->
			        <div class="block-heading-two">
				       <h4 class="h"><span>About Our Property Services</span></h4>
			        </div>
